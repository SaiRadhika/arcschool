...
public class CityPageObject extends BaseClass {
	...
	//****************************Quality Of Life--> Health And Safety Objects************************
		...
		//****************************Quality Of Life--> Equitability: Gini coefficient (for income distribution)************************
				...
				//****************************Quality Of Life--> Health & Safety: Air quality days unhealthy for sensitive groups (Days/yr)************************
	...
	// This method will click on Transportation --> VMT
		public void ClickonVMT() {
			...
			log.info("ClickonVMT method started here.....");
				...
				Transport_VMT.click();
				waithelper.WaitForElementVisibleWithPollingTime(
						driver.findElement(By.xpath("(//*[contains(text(),'Vehicle miles traveled on individual vehicles daily (VMT)')])[4]")),
						Integer.parseInt(prop.getProperty("explicitTime")), 2);
				log.info("ClickonVMT method ends here.....");
			
		}

		// This method will click on Quality of Life --> Health And Safety: Median Air Quality Index (AQI)
				public void ClickonHealthAndSafety() {
					...
					log.info("ClickonHealthAndSafety method started here.....");
						...
						waithelper.WaitForElementVisibleWithPollingTime(
								driver.findElement(By.xpath("(//*[contains(text(),'Health & Safety: Median air quality index (AQI)')])[3]")),
								Integer.parseInt(prop.getProperty("explicitTime")), 2);
						log.info("ClickonHealthAndSafety method ends here.....");
					
				}
				
				// This method will click on Quality of Life --> Education: Population with (at least) Bachelor's degree (%)
				public void ClickonEducation_BachelorPopulation() {
					...
					log.info("ClickonEducation_BachelorPopulation method started here.....");
						...
						waithelper.WaitForElementVisibleWithPollingTime(
								driver.findElement(By.xpath("(//*[contains(text(),\"Education: Population with (at least) Bachelor's degree\")])[3]")),
								Integer.parseInt(prop.getProperty("explicitTime")), 2);
						log.info("ClickonEducation_BachelorPopulation method ends here.....");
					
				}
				// This method will click on Quality of Life --> Equitability: Gini coefficient (for income distribution)
				public void ClickonEquitability_Gini_Coeffiecient() {
					...
					log.info("ClickonEquitability_Gini_Coeffiecient method started here.....");
						...
						waithelper.WaitForElementVisibleWithPollingTime(
								driver.findElement(By.xpath("(//*[contains(text(),\"Equitability: Gini coefficient (for income distribution)\")])[4]")),
								Integer.parseInt(prop.getProperty("explicitTime")), 2);
						log.info("ClickonEquitability_Gini_Coeffiecient method ends here.....");
					
				}
				// This method will click on Quality of Life --> Education: Population with (at least) High School degree (%)
				public void ClickonEducation_HighSchoolPopulation() {
					...
					log.info("ClickonEducation_HighSchoolPopulation method started here.....");
						...
						waithelper.WaitForElementVisibleWithPollingTime(
								driver.findElement(By.xpath("(//*[contains(text(),\"Education: Population with (at least) High School degree (%)\")])[4]")),
								Integer.parseInt(prop.getProperty("explicitTime")), 2);
...
// This method will click on Quality of Life --> Prosperity: Median household income (US Dollars/Year)
				public void ClickonProsperity_MedianIncome() {
					...
					log.info("ClickonProsperity_MedianIncome method started here.....");
						...
						waithelper.WaitForElementVisibleWithPollingTime(
								driver.findElement(By.xpath("(//*[contains(text(),\"Prosperity: Median household income (US Dollars/Year)\")])[4]")),
								Integer.parseInt(prop.getProperty("explicitTime")), 2);
						log.info("ClickonProsperity_MedianIncome method ends here.....");
					
				}
				// This method will click on Quality of Life --> Equitability: Median gross rent as (%) of household income
				public void ClickonEquitability_MedianGrossIncome() {
					...
					log.info("ClickonEquitability_MedianGrossIncome method started here.....");
						...
						waithelper.WaitForElementVisibleWithPollingTime(
								driver.findElement(By.xpath("(//*[contains(text(),\"Equitability: Median gross rent as (%) of household income\")])[4]")),
								Integer.parseInt(prop.getProperty("explicitTime")), 2);
						log.info("ClickonEquitability_MedianGrossIncome method ends here.....");
					
				}
				// This method will click on Quality of Life --> Prosperity: Unemployment rate (%) of household income
				...
				// This method will click on Quality of Life --> Health & Safety: Air quality days unhealthy for sensitive groups (Days/yr)
				public void ClickonHealthAndSafetySensitiveGroup() {
					...
					log.info("ClickonHealthAndSafetySensitiveGroup method started here.....");
						...
						waithelper.WaitForElementVisibleWithPollingTime(
								driver.findElement(By.xpath("(//*[contains(text(),\"Health & Safety: Air quality days unhealthy for sensitive groups (Days/yr)\")])[3]")),
								Integer.parseInt(prop.getProperty("explicitTime")), 2);
						log.info("ClickonHealthAndSafetySensitiveGroup method ends here.....");
					
				}
				
				// This method will click on Quality of Life --> Health & Safety: Violent Crime (per year per capita)
				public void ClickonHealthAndSafetyVoilentCrime() {
					...
					log.info("ClickonHealthAndSafetyVoilentCrime method started here.....");
						...
						waithelper.WaitForElementVisibleWithPollingTime(
								driver.findElement(By.xpath("(//*[contains(text(),\"Health & Safety: Violent Crime (per year per capita)\")])[3]")),
								Integer.parseInt(prop.getProperty("explicitTime")), 2);
	...
	public void ClickonMunicipalSolidWasteDiversion() {
		...
		waithelper.WaitForElementVisibleWithPollingTime(
				driver.findElement(By.xpath("(//*[contains(text(),'Municipal solid waste diversion rate from landfill')])[4]")),
				Integer.parseInt(prop.getProperty("explicitTime")), 2);
		try {
			Thread.sleep(4000);
		} catch (InterruptedException e) {
	...
	public boolean checkPopulation_AddRow_Header_Display() {
		...
		try {
			// PopulationTab.click();
			Thread.sleep(3000);
			waithelper.WaitForElementClickable(ProjectSettingAddRowButton,Integer.parseInt(prop.getProperty("explicitTime")), 2);
	...
	public boolean checkPopulationCommentAndActivity(String comment, String uname) {
		...
		waithelper.WaitForElementClickable(Population_CommentTextBox, Integer.parseInt(prop.getProperty("explicitTime")), 2);
		Population_CommentTextBox.sendKeys(comment);
		waithelper.WaitForElementClickable(Population_PostButton, Integer.parseInt(prop.getProperty("explicitTime")), 2);
		...
		waithelper.WaitForElementClickable(Population_ActivityButton, Integer.parseInt(prop.getProperty("explicitTime")), 2);
		...
		String ActivityDate = driver.findElement(By.xpath("//table[@class='mb10 ng-scope']/thead/tr/th[1]/p")).getText();
		String ActivityTime = driver.findElement(By.xpath("//table[@class='mb10 ng-scope']/tbody/tr/td[1]/span")).getText().toLowerCase();
		String ActivtyComment = driver.findElement(By.xpath("//table[@class='mb10 ng-scope']/tbody/tr/td[2]/p")).getText();
		...
		if (Commentflag && (ActivityDate.equals(strDate)) && (ActivityTime.equals(currentTime)) && (ActivtyComment.equals(ExpComment)) ) {
	...
	// This method will add comment and check in activity section DI - > Energy
		...
		public boolean checkEnergyCommentAndActivity(String comment, String uname) {
			...
			waithelper.WaitForElementClickable(Energy_CommentTextBox, Integer.parseInt(prop.getProperty("explicitTime")), 2);
			...
			//waithelper.WaitForElementVisibleWithPollingTime(driver.findElement(By.xpath("(//p[text()='" + comment + "'])[1]")), Integer.parseInt(prop.getProperty("explicitTime")), 2);
			String xp="(//p[text()='" + comment + "'])[2]";
			Commentflag = driver.findElement(By.xpath(xp)).isDisplayed();
			//log.info("Commentenabled flag --"+ driver.findElement(By.xpath(xp)).isEnabled());
			log.info("Comment displayed flag --"+ Commentflag);
			waithelper.WaitForElementClickable(Energy_ActivityButton, Integer.parseInt(prop.getProperty("explicitTime")), 2);
			...
			String ActivityDate = driver.findElement(By.xpath("(//table[@class='mb20 ng-scope'])[2]/thead/tr/th/p")).getText();
			String ActivityTime = driver.findElement(By.xpath("(//table[@class='mb20 ng-scope']/tbody[1]/tr/td[1]/span)[2]")).getText().toLowerCase();
			String ActivityComment = driver.findElement(By.xpath("(//td[@class='vtop']/span[text()='"+ActivityTime+"'])[2]/parent::td/following-sibling::td/p")).getText();
			...
			if (Commentflag && (ActivityDate.equals(strDate)) && (ActivityTime.equals(currentTime)) && (ActivityComment.equals(ExpComment)) ) {
		...
		// This method will add comment and check in activity section DI - > Transportation
				...
				// This method will add comment and check in activity section Quality Of Life--> Prosperity: Unemployment rate (%)
				...
				public boolean checkProsperityUnemployementRate(String comment, String uname) {
					...
					waithelper.WaitForElementClickable(ProsperityUnemployementRate_CommentTextBox, Integer.parseInt(prop.getProperty("explicitTime")), 2);
					ProsperityUnemployementRate_CommentTextBox.sendKeys(comment);
					waithelper.WaitForElementClickable(ProsperityUnemployementRate_PostButton, Integer.parseInt(prop.getProperty("explicitTime")), 2);
					//Energy_PostButton.click();
					...
					//log.info("Commentenabled flag --"+ driver.findElement(By.xpath(xp)).isEnabled());
					log.info("Comment displayed flag --"+ Commentflag);
					waithelper.WaitForElementClickable(ProsperityUnemployementRate_ActivityButton, Integer.parseInt(prop.getProperty("explicitTime")), 2);
				...
				// This method will add comment and check in activity section Quality Of Life--> Health & Safety: Air quality days unhealthy for sensitive groups (Days/yr)
				//  - Details Tab and check it in Activity
				public boolean checkHealthAndSafetySensitiveGroup(String comment, String uname) {
					...
					waithelper.WaitForElementClickable(HealthAndSafetySensitiveGroup_CommentTextBox, Integer.parseInt(prop.getProperty("explicitTime")), 2);
					HealthAndSafetySensitiveGroup_CommentTextBox.sendKeys(comment);
					waithelper.WaitForElementClickable(HealthAndSafetySensitiveGroup_PostButton, Integer.parseInt(prop.getProperty("explicitTime")), 2);
					//Energy_PostButton.click();
					...
					//log.info("Commentenabled flag --"+ driver.findElement(By.xpath(xp)).isEnabled());
					log.info("Comment displayed flag --"+ Commentflag);
					waithelper.WaitForElementClickable(HealthAndSafetySensitiveGroup_ActivityButton, Integer.parseInt(prop.getProperty("explicitTime")), 2);
				...
				// This method will add comment and check in activity section Quality Of Life--> Health & Safety: Violent Crime (per year per capita)
				//  - Details Tab and check it in Activity
				public boolean checkHealthAndSafetyVoilentCrime(String comment, String uname) {
					...
					waithelper.WaitForElementClickable(HealthAndSafetyVoilentCrime_CommentTextBox, Integer.parseInt(prop.getProperty("explicitTime")), 2);
					HealthAndSafetyVoilentCrime_CommentTextBox.sendKeys(comment);
					waithelper.WaitForElementClickable(HealthAndSafetyVoilentCrime_PostButton, Integer.parseInt(prop.getProperty("explicitTime")), 2);
					//Energy_PostButton.click();
					...
					//log.info("Commentenabled flag --"+ driver.findElement(By.xpath(xp)).isEnabled());
					log.info("Comment displayed flag --"+ Commentflag);
					waithelper.WaitForElementClickable(HealthAndSafetyVoilentCrime_ActivityButton, Integer.parseInt(prop.getProperty("explicitTime")), 2);
				...
				public boolean checkAdditionalData_SaveRecords() {
					...
					List<WebElement> AdditionalItems = driver.findElements(By.xpath("//*[@class='water_unit add_item ng-scope']/span"));
					...
					for(WebElement ele:AdditionalItems)
					{
						...
						//JSHelper.scrollToElement(driver.findElement(By.xpath("//*[@id='addtional_data']")));
						...
						waithelper.WaitForElementClickable(Additional_Data_AddYearBtn,Integer.parseInt(prop.getProperty("explicitTime")), 2);
						try {
							Thread.sleep(2000);
						...
						int Selected_Year = Integer.parseInt(driver
								.findElement(By.xpath("//table[@class='table arcTbl cityTable']/tbody/tr["+row+"]/td[1]/input")).getAttribute("value"));
						log.info("Selected Year is ---" + Selected_Year);
						if (CommonMethod.getCurrentYear() - Selected_Year == 1) {
							driver.findElement(By.xpath("//table[@class='table arcTbl cityTable']/tbody/tr["+row+"]/td[3]/input"))
									.sendKeys(Integer.toString(value));
							driver.findElement(By.xpath("//table[@class='table arcTbl cityTable']/tbody/tr["+row+"]/td[4]/input")).sendKeys(UnitValue);
							driver.findElement(By.xpath("//table[@class='table arcTbl cityTable']/tbody/tr["+row+"]/td[5]/button")).click();
							try {
							waithelper.WaitForElementInvisible(driver.findElement(By.xpath("//table[@class='table arcTbl cityTable']/tbody/tr["+row+"]/td[6]/div/*")),
									Integer.parseInt(prop.getProperty("explicitTime")), 2);
							}
							catch(Exception e)
							{
							...
							flag = driver.findElement(By.xpath("//table[@class='table arcTbl cityTable']/tbody/tr[1]/td[5]/button/span[text()='Edit']")).isDisplayed();
							if(flag)
							{
				...
				// This method will add comment and check in activity section DI - >Quality Of Life--> Health And Safety
				// - Details Tab and check it in Activity
				public boolean checkHealthAndSafetyCommentAndActivity(String comment, String uname) {
					...
					waithelper.WaitForElementClickable(HealthAndSafety_CommentTextBox, Integer.parseInt(prop.getProperty("explicitTime")), 2);
					HealthAndSafety_CommentTextBox.sendKeys(comment);
					waithelper.WaitForElementClickable(HealthAndSafety_PostButton, Integer.parseInt(prop.getProperty("explicitTime")), 2);
					//Energy_PostButton.click();
					...
					//log.info("Commentenabled flag --"+ driver.findElement(By.xpath(xp)).isEnabled());
					log.info("Comment displayed flag --"+ Commentflag);
					waithelper.WaitForElementClickable(HealthAndSafety_ActivityButton, Integer.parseInt(prop.getProperty("explicitTime")), 2);
		...
		// This method will add comment and check in activity section DI - > Water
				...
				public boolean checkWaterCommentAndActivity(String comment, String uname) {
					...
					String ActivityDate = driver.findElement(By.xpath("(//table[@class='mb20 ng-scope']/thead/tr/th[1]/p)[2]")).getText();
					String ActivityTime = driver.findElement(By.xpath("(//table[@class='mb20 ng-scope']/tbody[1]/tr/td[1]/span)[2]")).getText().toLowerCase();
					//String ActivtyComment = driver.findElement(By.xpath("//table[@class='mb20 ng-scope']/tbody/tr/td[2]/p")).getText();
					
					String ExpComment = uname + " commented in Water Consumption";
					//boolean ActivityTime = driver.findElement(By.xpath("(//td[@class='vtop']/span[text()='"+currentTime+"'])[2]")).isDisplayed();
					String ActivityComment = driver.findElement(By.xpath("(//td[@class='vtop']/span[text()='"+ActivityTime+"'])[2]/parent::td/following-sibling::td/p")).getText();
				...
				public boolean checkWasteGenerationCommentAndActivity(String comment, String uname) {
					...
					waithelper.WaitForElementClickable(Waste_Gen_CommentTextBox, Integer.parseInt(prop.getProperty("explicitTime")), 2);
					...
					Commentflag = driver.findElement(By.xpath("(//p[text()='" + comment + "'])[2]")).isDisplayed();
					waithelper.WaitForElementClickable(Waste_Gen_ActivityButton, Integer.parseInt(prop.getProperty("explicitTime")), 2);
					...
					String ActivityDate = driver.findElement(By.xpath("(//table[@class='mb20 ng-scope']/thead/tr/th[1]/p)[2]")).getText();
					String ActivityTime = driver.findElement(By.xpath("(//table[@class='mb20 ng-scope']/tbody[1]/tr/td[1]/span)[2]")).getText().toLowerCase();
					//String ActivtyComment = driver.findElement(By.xpath("(//table[@class='mb20 ng-scope']/tbody/tr/td[2]/p)[2]")).getText();
				...
				// This method will add comment and check in activity section DI - > Waste
				// - > Municipal solid waste diversion rate from landfill and check it in Activity
				public boolean checkWasteDiversionCommentAndActivity(String comment, String uname) {
					...
					waithelper.WaitForElementClickable(Waste_Div_CommentTextBox, Integer.parseInt(prop.getProperty("explicitTime")), 2);
					...
					Commentflag = driver.findElement(By.xpath("(//p[text()='" + comment + "'])[2]")).isDisplayed();
					waithelper.WaitForElementClickable(Waste_Div_ActivityButton, Integer.parseInt(prop.getProperty("explicitTime")), 2);
		...
		// This method will add comment and check in activity section DI - > Project
				...
				public boolean checkProjectAreaCommentAndActivity(String comment, String uname) {
					...
					waithelper.WaitForElementVisibleWithPollingTime(driver.findElement(By.xpath("//*[contains(text(),'PROJECT AREA')]")),
							Integer.parseInt(prop.getProperty("explicitTime")), 2);
					ProjectArea_CommentTextBox.sendKeys(comment);
					waithelper.WaitForElementClickable(ProjectArea_PostButton, Integer.parseInt(prop.getProperty("explicitTime")), 2);
					...
					//Activityflag = driver.findElement(By.xpath("(//p[text()='" + uname + " commented in Population'])[1]")).isDisplayed();
	...
	public boolean checkPopulation_Save_New_Row(String population) {
		...
		//ithelper.WaitForElementInvisible(	driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[4]/button/span[text()='Save']")),Integer.parseInt(prop.getProperty("explicitTime")), 2);
		
		waithelper.WaitForElementVisibleWithPollingTime(
				driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[4]/*[@class='fade-out saved_symbol']")),
				Integer.parseInt(prop.getProperty("explicitTime")), 2);
	...
	public boolean checkProjectArea_Save_New_Row(String PArea) {
		...
		String DecadeCal = DecadeCalenderHeader.getText();
		//driver.findElement(By.xpath("(//table[@class='table-condensed'])[2]/tbody/tr/td/span[3]")).click();
		driver.findElement(By.xpath("(//table[@class='table-condensed'])[2]/tbody/tr/td/span[@class='year old']/following-sibling::span[1]")).click();
		String[] s1 = DecadeCal.split("-");
		int Start_Year = Integer.parseInt(s1[0]);
		int End_Year = Integer.parseInt(s1[1]);
		if (End_Year - Start_Year == 9) {
		...
		//waithelper.WaitForElementVisibleWithPollingTime(driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[5]/span")),Integer.parseInt(prop.getProperty("explicitTime")), 2);
		waithelper.WaitForElementInvisible(
				driver.findElement(
						By.xpath("(//table[@class='meterListByType--wrapper']/tbody)[2]/tr[1]/td[3]/div/span/span/*")),
				Integer.parseInt(prop.getProperty("explicitTime")), 2);
	...
	// Project Setting -- > Population --> This method will add records and check whether filter is working or not
		...
		public boolean CheckPopulationFilter() {
			...
			for(int i=StartYear;i<CurrentYear;i++)
			{
				...
				driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[2]/input")).sendKeys(Integer.toString(population));
			...
			waithelper.WaitForElementClickable(YearUpdateBtn,
					Integer.parseInt(prop.getProperty("explicitTime")), 2);
			YearUpdateBtn.click();
			int j=1;
			for(int i=filterEndYear;i>=filterStartYear;i--)
			{
				String currentyear=driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr["+j+"]/td[1]/input")).getAttribute("value");
			...
			try {
			boundaryflag=driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr["+j+"]/td[1]/input")).isDisplayed();
		...
		// Project Setting -- > Project Area --> This method will add records and check whether filter is working or not
				...
				public boolean CheckProjectAreaFilter() {
					...
					for(int i=StartYear;i<CurrentYear;i++)
					{
						...
						//driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[1]/input")).sendKeys(Integer.toString(i));
						driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[2]/input")).sendKeys(Integer.toString(PArea));
						driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[4]/button")).click();
				...
				// GHG Emissions -- > Energy --> This method will add records and check whether filter is working or not
				...
				public boolean CheckEnergyFilter() {
					...
					waithelper.WaitForElementVisibleWithPollingTime(
							driver.findElement(
									By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[4]/span")),
							Integer.parseInt(prop.getProperty("explicitTime")), 2);
				...
				// Transportation -- > VMT --> This method will add records and check whether filter is working or not
				...
				public boolean CheckTransportationFilter() {
					...
					driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[2]/input")).sendKeys(Integer.toString(Miles));
					driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[3]/button")).click();
				...
				// Quality Of Life--> Health And Safety --> This method will add records and check whether filter is working or not
				...
				public boolean CheckHealthAndSafetyFilter() {
					...
					for(int i=StartYear;i<CurrentYear;i++)
					{
						waithelper.WaitForElementClickable(NextYearbutton,
								Integer.parseInt(prop.getProperty("explicitTime")), 2);
				...
				// Quality Of Life--> Education: Population with (at least) Bachelor's degree (%) --> This method will add records and check whether filter is working or not

				public boolean CheckEducation_Bachelor_Population_Filter() {
					log.info("CheckEducation_Bachelor_Population_Filter starts here ................");
					waithelper.WaitForElementClickable(Education_BachelorPopulation_Data_AddYearBtn,Integer.parseInt(prop.getProperty("explicitTime")), 2);
					...
					driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[2]/input")).sendKeys(Integer.toString(Percent));
					driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[3]/button")).click();
				...
				// Quality Of Life--> Equitability: Gini coefficient (for income distribution) --> This method will add records and check whether filter is working or not

				public boolean CheckEquitability_Gini_Coefficient_Filter() {
					log.info("CheckEquitability_Gini_Coefficient_Filter starts here ................");
					
					waithelper.WaitForElementClickable(Equitability_Gini_Coefficient_Data_AddYearBtn,Integer.parseInt(prop.getProperty("explicitTime")), 2);
					...
					driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[2]/input")).sendKeys(Integer.toString(value));
					driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[3]/button")).click();
				...
				// Quality Of Life--> Education: Population with (at least) High School degree (%) --> This method will add records and check whether filter is working or not
				...
				// Quality Of Life--> Prosperity: Median household income (US Dollars/Year) --> This method will add records and check whether filter is working or not
				...
				public boolean CheckProsperityMedianIncome_Filter() {
					...
					waithelper.WaitForElementClickable(ProsperityMedianIncome_Data_AddYearBtn, Integer.parseInt(prop.getProperty("explicitTime")), 2);
				...
				// Quality Of Life--> Equitability: Median gross rent as (%) of household income --> This method will add records and check whether filter is working or not
				...
				public boolean CheckEquitability_MedianGrossIncome_Filter() {
					...
					waithelper.WaitForElementClickable(Equitability_MedianGrossIncome_Data_AddYearBtn, Integer.parseInt(prop.getProperty("explicitTime")), 2);
				...
				// Quality Of Life--> Prosperity: Unemployment rate (%)  --> This method will add records and check whether filter is working or not
				...
				// Quality Of Life--> Health & Safety: Air quality days unhealthy for sensitive groups (Days/yr)  --> This method will add records and check whether filter is working or not
				...
				public boolean CheckHealthAndSafetySensitiveGroup_Filter() {
					...
					waithelper.WaitForElementClickable(HealthAndSafetySensitiveGroup_Data_AddYearBtn, Integer.parseInt(prop.getProperty("explicitTime")), 2);
				...
				// Quality Of Life--> Health & Safety: Violent Crime (per year per capita)  --> This method will add records and check whether filter is working or not
				...
				public boolean CheckHealthAndSafetyVoilentCrime_Filter() {
					...
					waithelper.WaitForElementClickable(HealthAndSafetyVoilentCrime_Data_AddYearBtn, Integer.parseInt(prop.getProperty("explicitTime")), 2);
				...
				// Waste -- > Waste Generation --> This method will add records and check whether filter is working or not

				public boolean CheckWaste_GenerationFilter() {
					log.info("CheckWaste_GenerationFilter starts here ................");
					//Waste_AddYearButton.click();
					waithelper.WaitForElementClickable(Waste_AddYearButton,
							Integer.parseInt(prop.getProperty("explicitTime")), 2);
				...
				// Water Consumption -- >  This method will add records and check whether filter is working or not
				...
				public boolean CheckWaterFilter() {
					...
					waithelper.WaitForElementVisibleWithPollingTime(
							driver.findElement(
									By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[6]/span")),
							Integer.parseInt(prop.getProperty("explicitTime")), 2);
	...
	// This method will check whether Data and Details Tab is displaying or not
		...
		// This method will check whether Data and Details Tab is displaying or not
				...
				// This method will check whether Data and Details Tab is displaying or not
				// (Data Input - > Quality Of life --> Education: Population with (at least) Bachelor's degree (%) - > Data/Details Tab
				...
				// This method will check whether Data and Details Tab is displaying or not
				// (Data Input - > Quality Of life --> Equitability: Gini coefficient (for income distribution) - > Data/Details Tab
				...
				// This method will check whether Data and Details Tab is displaying or not
				// (Data Input - > Quality Of life --> Education: Population with (at least) High School degree (%) - > Data/Details Tab
				...
				// This method will check whether Data and Details Tab is displaying or not
				// (Data Input - > Quality Of life --> Prosperity: Median household income (US Dollars/Year) - > Data/Details Tab
				...
				// This method will check whether Data and Details Tab is displaying or not
				// (Data Input - > Quality Of life --> Equitability: Median gross rent as (%) of household income - > Data/Details Tab
				...
				// This method will check whether Data and Details Tab is displaying or not
				// (Data Input - > Quality Of life --> Prosperity: Unemployment rate (%) - > Data/Details Tab
				...
				// This method will check whether Data and Details Tab is displaying or not
				// (Data Input - > Quality Of life --> Health & Safety: Air quality days unhealthy for sensitive groups (Days/yr) - > Data/Details Tab
				...
				// This method will check whether Data and Details Tab is displaying or not
				// (Data Input - > Quality Of life -->Health & Safety: Violent Crime (per year per capita) - > Data/Details Tab
	...
	// This method will check whether Data and Details Tab is displaying or not
		// (Data Input - > Waste  - > Municipal solid waste diversion rate from landfill Data/Details Tab
	...
	// This method will check on clicking Add Year button, new row should be listed
			...
			public boolean CheckTransport_VMT_AddYear_NewRow_Display() {
				...
				waithelper.WaitForElementClickable(VMT_Data_AddYearBtn,
						Integer.parseInt(prop.getProperty("explicitTime")), 2);
				VMT_Data_AddYearBtn.click();
	...
	// This method will check on clicking Add Year button, new row should be listed
		// with previous year (Data Input - > Quality Of Life - > Health & Safety: Median air quality index (AQI)--> Data/Details Tab
		...
		// This method will check on clicking Add Year button, new row should be listed
				...
				// This method will check on clicking Add Year button, new row should be listed
				// with previous year (Data Input - > Quality of Life -- >	Prosperity: Median household income (US Dollars/Year)--> Data/Details Tab
				...
				// This method will check on clicking Add Year button, new row should be listed
				// with previous year (Data Input - > Quality of Life -- >	Equitability: Median gross rent as (%) of household income--> Data/Details Tab
				...
				// This method will check on clicking Add Year button, new row should be listed
				// with previous year (Data Input - > Quality of Life -- >	Prosperity: Unemployment rate (%)--> Data/Details Tab
				...
				// This method will check on clicking Add Year button, new row should be listed
				// with previous year (Data Input - > Quality of Life -- >	Health & Safety: Violent Crime (per year per capita)--> Data/Details Tab
	...
	public boolean CheckGHGEmission_SaveNewRecord() {
		...
		log.info("Before adding number of row showing is ---" + TableRow.size());
		boolean flag = false;
		waithelper.WaitForElementClickable(GHGEmission_Data_AddYearBtn,Integer.parseInt(prop.getProperty("explicitTime")), 2);
		GHGEmission_Data_AddYearBtn.click();
		int Selected_Year = Integer.parseInt(driver
				.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[1]/input")).getAttribute("value"));
		log.info("Selected Year is ---" + Selected_Year);
	...
	// This method will add one row with previous year in Data Input - > Transportation  - > Data Tab
		...
		public boolean CheckTransportation_SaveNewRecord() {
			...
			if (CommonMethod.getCurrentYear() - Selected_Year == 1) {
				...
				driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[3]/button")).click();
				waithelper.WaitForElementVisibleWithPollingTime(driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[3]/button")),
						Integer.parseInt(prop.getProperty("explicitTime")), 2);
				
				waithelper.WaitForElementInvisible(driver.findElement(By.xpath("(//table[@class='meterListByType--wrapper']/tbody/tr[1])[4]/td[3]/div/span/span/*")),
						Integer.parseInt(prop.getProperty("explicitTime")), 2);
				flag = driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[3]/button/span[text()='Edit']")).isDisplayed();
			}
		...
		// This method will add one row with previous year in Data Input - > Quality Of Life  - > Health And Safety) --> Data Tab
				...
				public boolean CheckHealthAndSafety_SaveNewRecord() {
					...
					if (CommonMethod.getCurrentYear() - Selected_Year == 1) {
						...
						waithelper.WaitForElementInvisible(driver.findElement(By.xpath("(//table[@class='meterListByType--wrapper']/tbody/tr[1])[5]/td[3]/div/span/span/*")),
								Integer.parseInt(prop.getProperty("explicitTime")), 2);
						flag = driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[3]/button/span[text()='Edit']")).isDisplayed();
					}
				...
				// This method will add one row with previous year in Data Input - > Quality Of Life  - > Education: Population with (at least) Bachelor's degree (%) --> Data Tab
				...
				public boolean CheckEductaion_Bachelor_Population_SaveNewRecord() {
					...
					Education_BachelorPopulation_Data_AddYearBtn.click();
					waithelper.WaitForElementVisibleWithPollingTime(PreviousYearbutton,Integer.parseInt(prop.getProperty("explicitTime")), 2);
					try {
						Thread.sleep(3000);
					} catch (InterruptedException e) {
						// TODO Auto-generated catch block
				...
				// This method will add one row with previous year in Data Input - > Quality Of Life  - > Equitability: Gini coefficient (for income distribution) --> Data Tab
				...
				// This method will add one row with previous year in Data Input - > Quality Of Life  - > Education: Population with (at least) High School degree (%) --> Data Tab
				...
				// This method will add one row with previous year in Data Input - > Quality Of Life  - > Prosperity: Median household income (US Dollars/Year) --> Data Tab
				...
				// This method will add one row with previous year in Data Input - > Quality Of Life  - > Equitability: Median gross rent as (%) of household income --> Data Tab
				...
				// This method will add one row with previous year in Data Input - > Quality Of Life  - > Prosperity: Unemployment rate (%) --> Data Tab
				...
				public boolean CheckProsperityUnemployementRate_SaveNewRecord() {
					...
					boolean flag = false;
					//JSHelper.clickElement(ProsperityMedianIncome_Data_AddYearBtn);
					waithelper.WaitForElementClickable(ProsperityUnemployementRate_Data_AddYearBtn,Integer.parseInt(prop.getProperty("explicitTime")), 2);
					//JSHelper.clickElement(ProsperityMedianIncome_Data_AddYearBtn);
					try {
				...
				// This method will add one row with previous year in Data Input - > Quality Of Life  - > Health & Safety: Air quality days unhealthy for sensitive groups (Days/yr) --> Data Tab
				...
				// This method will add one row with previous year in Data Input - > Quality Of Life  - > Health & Safety: Violent Crime (per year per capita) --> Data Tab
		...
		// This method will Edit Record in Data Input - > Transportation  - > Data Tab
				...
				public boolean CheckTransportation_EditRecord() {
					...
					boolean flag = false;
					waithelper.WaitForElementClickable(VMT_Data_Save_EditBtn,Integer.parseInt(prop.getProperty("explicitTime")), 2);
					VMT_Data_Save_EditBtn.click();
					int Selected_Year = Integer.parseInt(driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[1]/input")).getAttribute("value"));
					Selected_Year++;
					driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[1]/input")).click();
					waithelper.WaitForElementVisibleWithPollingTime(driver.findElement(By.xpath("(//table[@class='table-condensed'])[2]")),Integer.parseInt(prop.getProperty("explicitTime")), 2);
					...
					String Miles_Days_Capita = driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[2]/input")).getAttribute("value");
					...
					driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[2]/input")).sendKeys(Integer.toString(Miles_Days_CapitaNew));
					VMT_Data_Save_EditBtn.click();
					waithelper.WaitForElementVisibleWithPollingTime(driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[4]/span")),
					Integer.parseInt(prop.getProperty("explicitTime")), 2);
					waithelper.WaitForElementInvisible(driver.findElement(By.xpath("//table[@class='meterListByType--wrapper']/tbody[4]/tr[1]/td[3]/div/span[1]/span/*")), Integer.parseInt(prop.getProperty("explicitTime")), 2);
					flag = driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[3]/button/span[text()='Edit']")).isDisplayed();
				...
				// This method will Edit Record in Data Input - > Quality Of Life--> Health And Safety  - > Data Tab
				...
				public boolean CheckHealthAndSafety_EditRecord() {
					...
					String OldValue = driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[2]/input")).getAttribute("value");
					...
					waithelper.WaitForElementVisibleWithPollingTime(driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[4]/span")),
					Integer.parseInt(prop.getProperty("explicitTime")), 2);
					waithelper.WaitForElementInvisible(driver.findElement(By.xpath("//table[@class='meterListByType--wrapper']/tbody[5]/tr[1]/td[3]/div/span[1]/span/*")), Integer.parseInt(prop.getProperty("explicitTime")), 2);
					flag = driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[3]/button/span[text()='Edit']")).isDisplayed();
				...
				// This method will Edit Record in Data Input - > Quality Of Life--> Education: Population with (at least) Bachelor's degree (%)  - > Data Tab
				...
				// This method will Edit Record in Data Input - > Quality Of Life--> Equitability: Gini coefficient (for income distribution)  - > Data Tab
				...
				public boolean CheckEquitability_Gini_Coefficient_EditRecord() {
					...
					boolean flag = false;
					waithelper.WaitForElementClickable(Equitability_Gini_Coefficient_Data_Save_EditBtn,Integer.parseInt(prop.getProperty("explicitTime")), 2);
				...
				// This method will Edit Record in Data Input - > Quality Of Life--> Education: Population with (at least) High School degree (%)  - > Data Tab
				...
				public boolean CheckEducation_HighSchoolPopulation_EditRecord() {
					...
					boolean flag = false;
					waithelper.WaitForElementClickable(Education_HighSchoolPopulation_Data_Save_EditBtn,Integer.parseInt(prop.getProperty("explicitTime")), 2);
				...
				// This method will Edit Record in Data Input - > Quality Of Life--> Prosperity: Median household income (US Dollars/Year)  - > Data Tab

				public boolean CheckProsperityMedianIncome_EditRecord() {
					log.info("CheckProsperityMedianIncome_EditRecord  starts here........");
					boolean flag = false;
					waithelper.WaitForElementClickable(ProsperityMedianIncome_Data_Save_EditBtn,Integer.parseInt(prop.getProperty("explicitTime")), 2);
				...
				// This method will Edit Record in Data Input - > Quality Of Life--> Equitability: Median gross rent as (%) of household income  - > Data Tab
				...
				public boolean CheckEquitability_MedianGrossIncome_EditRecord() {
					...
					boolean flag = false;
					waithelper.WaitForElementClickable(Equitability_MedianGrossIncome_Data_Save_EditBtn,Integer.parseInt(prop.getProperty("explicitTime")), 2);
				...
				// This method will Edit Record in Data Input - > Quality Of Life--> Prosperity: Unemployment rate (%)  - > Data Tab
				...
				public boolean CheckProsperityUnemployementRate_EditRecord() {
					...
					boolean flag = false;
					waithelper.WaitForElementClickable(ProsperityUnemployementRate_Data_Save_EditBtn,Integer.parseInt(prop.getProperty("explicitTime")), 2);
				...
				// This method will Edit Record in Data Input - > Quality Of Life--> Health & Safety: Air quality days unhealthy for sensitive groups (Days/yr)  - > Data Tab
				...
				public boolean CheckHealthAndSafetySensitiveGroup_EditRecord() {
					...
					boolean flag = false;
					waithelper.WaitForElementClickable(HealthAndSafetySensitiveGroup_Data_Save_EditBtn,Integer.parseInt(prop.getProperty("explicitTime")), 2);
				...
				// This method will Edit Record in Data Input - > Quality Of Life--> Health & Safety: Violent Crime (per year per capita)   - > Data Tab
				...
				public boolean CheckHealthAndSafetyVoilentCrime_EditRecord() {
					...
					boolean flag = false;
					waithelper.WaitForElementClickable(HealthAndSafetyVoilentCrime_Data_Save_EditBtn,Integer.parseInt(prop.getProperty("explicitTime")), 2);
	...
	public boolean CheckGHGEmission_EditRow() {
		...
		log.info(Integer.toString(Integer.parseInt(data.getCellData("City", 4, 2)) + 5));
		String Tons_Year_Capita = Integer.toString(Integer.parseInt(data.getCellData("City", 4, 2)) + 5);
		...
		//waithelper.WaitForElementVisibleWithPollingTime(driver.findElement(By.xpath("//div[@id='scoreTip']")),
		//		Integer.parseInt(prop.getProperty("explicitTime")), 2);
		waithelper.WaitForElementInvisible(driver.findElement(By.xpath("(//table[@class='meterListByType--wrapper']/tbody/tr[1])[1]/td[3]/div/span/span/*")), Integer.parseInt(prop.getProperty("explicitTime")), 2);
		flag = driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[1]/td[3]/button/span[text()='Edit']")).isDisplayed();
	...
	// This method will Edit Row in Data Input - > Waste - > Municipal solid waste diversion rate from landfill
...
// This method will Delete Row in Data Input - > Waste - > Municipal solid waste generation intensity 
	...
	// This method will Delete Row in Data Input - > Waste - > Municipal solid waste diversion rate from landfill
		...
		// This method will Delete Row in Data Input - > Transportation - > VMT
				...
				public boolean Transportation_VMT_DeleteRow() {
					...
					if (RowCountBefore > 1) {
						try {
							...
							waithelper.WaitForElementInvisible(driver.findElement(By
									.xpath("//table[@class='meterListByType--wrapper']/tbody[4]/tr[1]/td[3]/div/span[1]/span/*")),
									Integer.parseInt(prop.getProperty("explicitTime")), 2);
				...
				// This method will Delete Row in Data Input - > Quality Of Life--> Health And Safety
				...
				public boolean HealthAndSafety_DeleteRow() {
					...
					if (RowCountBefore > 1) {
						try {
							...
							waithelper.WaitForElementInvisible(driver.findElement(By
									.xpath("//table[@class='meterListByType--wrapper']/tbody[5]/tr[1]/td[3]/div/span[1]/span/*")),
									Integer.parseInt(prop.getProperty("explicitTime")), 2);
				...
				// This method will Delete Row in Data Input - > Quality Of Life--> Education: Population with (at least) Bachelor's degree (%)
				...
				// This method will Delete Row in Data Input - > Quality Of Life--> Equitability: Gini coefficient (for income distribution)
				...
				// This method will Delete Row in Data Input - > Quality Of Life--> Education: Population with (at least) High School degree (%)
				...
				// This method will Delete Row in Data Input - > Quality Of Life--> Prosperity: Median household income (US Dollars/Year)
				...
				// This method will Delete Row in Data Input - > Quality Of Life--> Equitability: Median gross rent as (%) of household income
				...
				// This method will Delete Row in Data Input - > Quality Of Life--> Prosperity: Unemployment rate (%)
				...
				// This method will Delete Row in Data Input - > Quality Of Life--> Health & Safety: Air quality days unhealthy for sensitive groups (Days/yr)
				...
				// This method will Delete Row in Data Input - > Quality Of Life--> Health & Safety: Violent Crime (per year per capita) 
...
// This method will add one row with previous year and One row with Next Year in Data Input - > GHG Emission - > Data Tab 
	...
	// This method will add one row with previous year and One row with Next Year in Data Input - > GHG Emission - > Data Tab 
		...
		// This method will add one row with previous year and One row with Next Year in Data Input - > Transportation - > Data Tab 
				...
				public boolean Transportation_VMT_SavePreviousAndNextYearRecord() {
					...
					boolean prev_flag = false;
					boolean Next_flag = false;
					int selected_year = Integer.parseInt(driver.findElement(By.xpath("//table[@id='readingsTable']/tbody/tr[2]/td[1]/input")).getAttribute("value"));
					if (CommonMethod.getCurrentYear() - selected_year == 2) {
				...
				// This method will add one row with previous year and One row with Next Year in Data Input - >Quality Of Life--> Health And Safety  - > Data Tab 
				...
				public boolean HealthAndSafety_SavePreviousAndNextYearRecord() {
					...
					waithelper.WaitForElementClickable(PreviousYearbutton,
							Integer.parseInt(prop.getProperty("explicitTime")), 2);
					PreviousYearbutton.click();
					try {
						Thread.sleep(3000);
				...
				// This method will add one row with previous year and One row with Next Year in Data Input - >Quality Of Life--> Education: Population with (at least) Bachelor's degree (%)  - > Data Tab 
				...
				// This method will add one row with previous year and One row with Next Year in Data Input - >Quality Of Life--> Equitability: Gini coefficient (for income distribution)  - > Data Tab 
				...
				// This method will add one row with previous year and One row with Next Year in Data Input - >Quality Of Life--> Education: Population with (at least) High School degree (%)  - > Data Tab 
				...
				// This method will add one row with previous year and One row with Next Year in Data Input - >Quality Of Life--> Equitability: Median gross rent as (%) of household income  - > Data Tab 
				...
				// This method will add one row with previous year and One row with Next Year in Data Input - >Quality Of Life--> Prosperity: Unemployment rate (%)  - > Data Tab 
				...
				// This method will add one row with previous year and One row with Next Year in Data Input - >Quality Of Life-->Health & Safety: Violent Crime (per year per capita)  - > Data Tab 
...
// This method will add one row with previous year in Data Input - > Waste - > Waste Generation -> Data Tab 
	...
	// This method will add one row with previous year in Data Input - > Waste - > Waste Diversion -> Data Tab 
