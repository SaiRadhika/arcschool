...
public class InsightPageTest extends BaseClass {
	...
	@Test(dependsOnGroups = "LoginMethodTCGroup", groups = {
			"Reboot" }, dependsOnMethods = "com.arc.testCases.HomePageTest.Login_To_Insight", priority = 41, enabled = true, description = "Markets-->Check the project count showing after searching")
	...
	@Test(dependsOnGroups = "LoginMethodTCGroup", groups = {
			"Reboot" }, dependsOnMethods = "com.arc.testCases.HomePageTest.Login_To_Insight", priority = 42, description = "Markets--> Validate by clicking on the Export button generates export")
	...
	@Test(dependsOnGroups = "LoginMethodTCGroup", groups = {
			"Reboot" }, dependsOnMethods = "com.arc.testCases.HomePageTest.Login_To_Insight", priority = 43, description = "Models--> Reductions --> Check the project count showing after searching")
	...
	@Test(dependsOnGroups = "LoginMethodTCGroup", groups = {
			"Reboot" }, dependsOnMethods = "com.arc.testCases.HomePageTest.Login_To_Insight", priority = 44, enabled = true, description = "Models--> Reductions -->Under reductions- Validate zepi Score gets generated")
	...
	@Test(dependsOnGroups = "LoginMethodTCGroup", groups = {
			"Reboot" }, dependsOnMethods = "com.arc.testCases.HomePageTest.Login_To_Insight", priority = 45, description = "Models--> Reductions --> Validate by clicking on the Export button generates export")
	...
	@Test(dependsOnGroups = "LoginMethodTCGroup", groups = {
			"Reboot" }, dependsOnMethods = "com.arc.testCases.HomePageTest.Login_To_Insight", priority = 46, description = "Models--> Strategies --> Check the project count showing after searching")
	...
	@Test(dependsOnGroups = "LoginMethodTCGroup", groups = {
			"Reboot" }, dependsOnMethods = "com.arc.testCases.HomePageTest.Login_To_Insight", priority = 47, description = "Models--> Strategies --> Validate by clicking on the Export button generates export")
